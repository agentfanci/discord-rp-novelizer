...
#nov2.read_in(r"C:\Users\A\Documents\Discord RP\Estate CSVs\Minds\Aquiline Estate - agent’s-mind [558716687839657995].csv")
#nov2.read_in(r"C:\Users\A\Documents\Discord RP\Estate CSVs\Minds\Aquiline Estate - calarics-mind [581155857677549578].csv")

t= timedelta(hours = 0.5)
nov2.novelize(t, "estate_test_4.txt")
